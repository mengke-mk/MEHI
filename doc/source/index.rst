...
这个简单的文档将告诉你如何使用MEHI这个库，API使用的注意事项，以及一些基本的例子。如果你赶时间，可以直接阅读第二章。另外，如果你在运行时发生的bug，请尽量从文档中获取支持，尤其是最后一章，列出了一些可能遇见的报错问题。顺便一说，这个文档只是一个参考，毕竟写的很仓促，一些错误是难免的。如果文档中的例子，描述和实际情况有出入，你来打我啊?
