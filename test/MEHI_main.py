...
if __name__ == '__main__':
    ...
    @exeTime
    def preprocess(L_img_stack, R_img_stack):
	#L_img_stack = IO_tool.read(left_pwd) 
        #R_img_stack = IO_tool.read(right_pwd)
        L_img_stack = prep.intensity_normalization(L_img_stack, 16)
	R_img_stack = prep.intensity_normalization(R_img_stack, 16)
	...
	L_img_stack = prep.intensity_normalization(L_img_stack, 8)
	R_img_stack = prep.intensity_normalization(R_img_stack, 8)
...
########################################
    ...
    L_img_stack, R_img_stack = preprocess(L_img_stack, R_img_stack)
    ...
    IO_tool.write('test.tif', L_img_stack)
